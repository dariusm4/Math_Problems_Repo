...
Each of 5 positions can be any digit $0$–$9$:
...
This is a k-permutation — choose 5 from 10 digits, order matters, no repetition:

$$P(10, 5) = \frac{10!}{5!} = 10 \cdot 9 \cdot 8 \cdot 7 \cdot 6 = 30\,240$$
